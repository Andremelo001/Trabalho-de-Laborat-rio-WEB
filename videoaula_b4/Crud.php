...
class Crud 
{
	...
	if ($sql->execute()) {
		...
		echo "Problema ao tentar atualizar o registro! <br> <a href='readAll.php'> Voltar </a>";
	}
...
public function delete($id){
	...
	if ($sql->execute()) {
		...
		echo "Problema ao tentar excluir o registro! <br> <a href='readAllDelete.php'> Voltar </a>";
	}
